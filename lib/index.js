...
var Formsy = function (_React$Component) {
  ...
  function Formsy(props) {
    ...
    _this.componentDidMount = function () {
      var validateOnLoad = _this.props.validateOnLoad;
    ...
    _this.detachFromForm = function (component, validateOnUnmount) {
    ...
    _this.validateForm = function () {
      ...
      _this.inputs.forEach(function (component, index) {
        ...
        if (!validation.isValid) {
          errors.push({ component: component, validation: validation });
        }
    ...
    _this.render = function () {
      var _this$props = _this.props,
          ...
          validateOnLoad = _this$props.validateOnLoad,
          nonFormsyProps = _objectWithoutProperties(_this$props, ['getErrorMessage', 'getErrorMessages', 'getValue', 'hasValue', 'isFormDisabled', 'isFormSubmitted', 'isPristine', 'isRequired', 'isValid', 'isValidValue', 'mapping', 'onChange', 'onInvalidSubmit', 'onInvalid', 'onReset', 'onSubmit', 'onValid', 'onValidSubmit', 'preventExternalInvalidation', 'resetValue', 'setValidations', 'setValue', 'showError', 'showRequired', 'validationErrors', 'validateOnLoad']);
...
Formsy.propTypes = {
  ...
  validateOnLoad: _propTypes2.default.bool,
